import type { Product, Customer, User, Sale, Expense, CompanyValuation, Deposit, AdminBusinessData } from './types';
import React from 'react';

// LOGO
export const MAKETUP_LOGO_URI = "./maketup-logo.png";
...
// FIX: Added definitions for all missing icons
export const ChatHelpIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const TransactionIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7h.01M12 7h.01M16 7h.01M9 17h6M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
    </svg>
);
...
export const BarcodeIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
      <path d="M3 4h2v16H3V4zm3 0h1v16H6V4zm2 0h2v16H8V4zm3 0h1v16h-1V4zm2 0h3v16h-3V4zm4 0h2v16h-2V4z" />
    </svg>
);
...
export const TruckIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 17H6V6h11v4l4 4H13z" />
    </svg>
);
...
export const DUMMY_PRODUCTS: Product[] = [
    ...
    { id: 'prod-2', name: 'Espresso Beans', category: 'Coffee', price: 22, costPrice: 10, stock: 20, imageUrl: 'https://via.placeholder.com/150', commissionPercentage: 10 },
];
...
export const DUMMY_EXPENSES: Expense[] = [
    { id: 'exp-1', date: new Date().toISOString(), category: 'Rent', description: 'Monthly rent', amount: 1500 },
];
export const DUMMY_DEPOSITS: Deposit[] = [
    { id: 'dep-1', date: new Date().toISOString(), amount: 500, description: 'Morning cash sales', userId: 'user-3', status: 'approved' }
];
export const COMPANY_VALUATION_HISTORY: CompanyValuation[] = [
    { date: '2023-01-01', value: 50000 },
    { date: '2023-06-01', value: 75000 },
];
...
export const DUMMY_ADMIN_BUSINESS_DATA: AdminBusinessData[] = [
    {
        ...
        profile: {
            ...
            businessEmail: 'contact@cornercafe.com',
            businessPhone: '+1-202-555-0104',
            logo: 'https://via.placeholder.com/150/4F46E5/FFFFFF?text=CC',
            isPublic: true,
        },
        settings: {
